function varargout = songedit_01(varargin)
% SONGEDIT_01 M-file for songedit_01.fig
%      SONGEDIT_01, by itself, creates a new SONGEDIT_01 or raises the existing
%      singleton*.
%
%      H = SONGEDIT_01 returns the handle to a new SONGEDIT_01 or the handle to
%      the existing singleton*.
%
%      SONGEDIT_01('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SONGEDIT_01.M with the given input arguments.
%
%      SONGEDIT_01('Property','Value',...) creates a new SONGEDIT_01 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before songedit_01_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to songedit_01_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help songedit_01
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @songedit_01_OpeningFcn, ...
                   'gui_OutputFcn',  @songedit_01_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before songedit_01 is made visible.
function songedit_01_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to songedit_01 (see VARARGIN)
...
% Choose default command line output for songedit_01
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes songedit_01 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = songedit_01_OutputFcn(hObject, eventdata, handles) 
