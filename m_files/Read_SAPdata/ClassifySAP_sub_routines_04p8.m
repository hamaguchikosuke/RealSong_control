function varargout=ClassifySAP_sub_routines_04p8(opt,varargin)
...
sap.pm.template_classify_dim_index=[...
    ...
    case 'init_figures'
        ...
        for ii=1:length(sap.pm.cluster_types)
            % evaltxt = sprintf('sap.gph.ui_cluster_type(%d) = uicontrol(''Style'',''Radio'',''Value'',0,''String'',sap.pm.cluster_types{%d},''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_cluster_type_select,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_04p8(''''%s'''')'');',...
        ...
        set(sap.gph.ui_cluster_type_select,'SelectionChangeFcn','ClassifySAP_sub_routines_04p8(''select_cluster_data_type'')');
        ...
        sap.gph.ui_teacher_cluster_ONOFF = uicontrol('Style','Radio',...
            ...
            'CallBack','ClassifySAP_sub_routines_04p8(''set_teacher_OnOff'');');
        sap.gph.ui_Stimlated_cluster_ONOFF = uicontrol('Style','Radio',...
            'Value',1,'String','stimulated','unit','normalized','pos',[.12 .90 .1 .03],...
            'CallBack','ClassifySAP_sub_routines_04p8(''set_Stimlated_cluster_ONOFF'');');
        ...
        sap.gph.ui_teacher_loadbutton = uicontrol('Style','pushbutton',...
            ...
            'CallBack','ClassifySAP_sub_routines_04p8(''load_teacher_database'');');
        ...
        dx = 1; dy=1/10;
        for ii=[0:8]
            evaltxt = sprintf('sap.gph.ui_cluster%d = uicontrol(''Style'',''Radio'',''Value'',1,''String'',[''cluster'' num2str(%d) '':(--)''],''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_clusterselect,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_04p8(''''%s'''')'');',...
                mod(ii,9),mod(ii,9),0,1-(ii+1)*dy,.6,'update_datatmp');
            eval(evaltxt);
        end
        ii=9; % for noise.
        evaltxt = sprintf('sap.gph.ui_cluster%d = uicontrol(''Style'',''Radio'',''Value'',1,''String'',[''noise'' num2str(%d) '':(--)''],''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_clusterselect,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_04p8(''''%s'''')'');',...
        ...
        uicontrol('Style', 'pushbutton','String', 'show syllable',...
            'Unit','Normalized','Position', [.25 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''show_syllable'');');
        
        uicontrol('Style', 'pushbutton','String', 'redraw',...
            'Unit','Normalized','Position', [.35 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''redraw'');');
        
        uicontrol('Style', 'pushbutton','String', 'select&annotate',...
            'Unit','Normalized','Position', [.45 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''select_rect_annotate'');');
        
        
        
        uicontrol('Style', 'pushbutton','String', 'LoadDatabase',...
            'Unit','Normalized','Position', [.55 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''load_database'');');
        
        uicontrol('Style', 'pushbutton','String', 'LoadDatabase+DAK',...
            'Unit','Normalized','Position', [.55 .95 .09 yh],...
            'Tooltip','Load mysql database generated by .dak data','Callback', 'ClassifySAP_sub_routines_04p8(''load_database_dak'');');
        
        
        uicontrol('Style', 'pushbutton','String', 'UploadDatabase',...
            'Unit','Normalized','Position', [.65 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''upload_database'');');
        
        
        uicontrol('Style', 'pushbutton','String', 'EditAnalysisParam',...
            'Unit','Normalized','Position', [.75 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''open_analysis_parameters'');');
        
        uicontrol('Style', 'pushbutton','String', 'ShowPrincomp',...
            'Unit','Normalized','Position', [.85 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p8(''show_princomp_axis'');');
        ...
        uicontrol('Style', 'pushbutton','String', 'play song',...
            'Unit','Normalized','Position', pos0,'Callback', 'ClassifySAP_sub_routines_04p8(''play_wholesong'');');
        
        uicontrol('Style', 'pushbutton','String', 'print sonogram',...
            'Unit','Normalized','Position', pos1,'Callback', 'ClassifySAP_sub_routines_04p8(''print_sonogram'');');
        
        % uicontrol('Style', 'pushbutton','String', 'play syllable',...
        %     'Unit','Normalized','Position', [.2 .4 xw yh],'Callback', 'ClassifySAP_sub_routines_04p8(''play_syllable'');');
        
        %         x=x+dx;
        %         uicontrol('Style', 'pushbutton','String', 'show classification',...
        %             'Unit','Normalized','Position', [x .4 xw yh],'Callback', 'ClassifySAP_sub_routines_04p8(''show_classification'');');
        %
        % uicontrol('Style', 'pushbutton','String', 'load feature',...
        %     'Unit','Normalized','Position', [.4 .4 xw yh],...
        %     'Callback', 'ClassifySAP_sub_routines_04p8(''load_feature'');');
        ...
        %             'Callback','ClassifySAP_sub_routines_04p8(''auto_classify'');');
        %
        %
        %         x=x+dx;
        ...
        %             'Callback','ClassifySAP_sub_routines_04p8(''auto_classify_all'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ExportSyllable','Transitions'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''export_syllable_transitions'');');
        ...
        uicontrol('Style', 'pushbutton','String', 'ShowTransMat',...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''show_trans_matrix'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ShowSyllable','Transition'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''show_syllable_tree'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'AlignSongFeat'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''align_song'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'BoutMotifHist'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''export_bout_durations'');');
        pos1=pos1+[dx,0 0,0];
        uicontrol('Style', 'pushbutton','String', {'Syl&GapHist'},...
            'FontSize',8,...
            'Unit','Normalized','Position', pos1, ...
            'ToolTips','Export syllable gap histgram',...
            'Callback','ClassifySAP_sub_routines_04p8(''export_syllable_gap_hist'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'TrainSVM'},...
            ...
            'Unit','Normalized','Position', pos0, ...
            'ToolTips','TrainSVM',...
            'Callback','ClassifySAP_sub_routines_04p8(''train_predict_svm'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'AlignSonogram'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''align_sonogram_plot'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'DeleteSong'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''delete_song_from_database'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ExportFeatures'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''export_features_of_a_syllable_type'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ShowFeatures ToMakeTemplates'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''show_features_to_make_templates'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ChangeSyllableThreshold'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''change_syllable_threshold'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'UpdateDetectedSyllables'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p8(''update_detected_syllables'');');
        
        
        
        %         ClassifySAP_sub_routines_04p8('init_feature_vector');
        ...
        set(sap.gph.ui_xbuttonG,'SelectionChangeFcn','ClassifySAP_sub_routines_04p8(''chk_xaxis_button'')');
        ...
        % Initialize some button group properties.
        set(sap.gph.ui_ybuttonG,'SelectionChangeFcn','ClassifySAP_sub_routines_04p8(''chk_yaxis_button'')');
        ...
        sap.gph.ui_select_song_by_filename=uicontrol(...
            ...
            'Unit','Normalized',...
            'Position', [.01 .1 .24 .3],...
            'Callback', 'ClassifySAP_sub_routines_04p8(''select_song_by_filename'');');
        ...
        for ii=1:length(sap.pm.feature_names)
            ...
            evaltxt=sprintf('set(%s,''Callback'',''ClassifySAP_sub_routines_04p8(''''chk_feature_button'''')'')',button_uiname);
            eval(evaltxt);
        end
        ...
        sap.gph.ui_shown_cluster_as_noise=uicontrol('Style','pushbutton','String', 'Register as Noise',...
            'FontSize',8,...
            'Unit','Normalized','Position', [.87 .05 .1 .05],'Callback', 'ClassifySAP_sub_routines_04p8(''register_shown_cluster_as_noise'');');
        
        
        sap.gph.ui_register_shown_cluster_to_Manual_cluster=uicontrol('Style','pushbutton','String', 'Register',...
            'Unit','Normalized','Position', [.87 0 .1 .05],'Callback', 'ClassifySAP_sub_routines_04p8(''register_shown_cluster_to_Manual_cluster'');');
        
        sap.gph.ui_spectrum_contrast=uicontrol('Style','slider','Value', 0.1*(1-sap.pm.sonogram_caxis_cutooff),...
            'Unit','Normalized','Position', [.85 0.1 .01 .3],'Callback', 'ClassifySAP_sub_routines_04p8(''set_spectrum_contrast'');');
        ...
        sap.gph.ui_amplitude_thresh=uicontrol('Style','slider','Value', sap.gpm.amplitude_thresh,...
            ...
            'Visible', 'on',...
            'Callback', 'ClassifySAP_sub_routines_04p8(''set_amp_thresh'');');
...
%         end
    ...
    case {'load_database','load_database_dak'}
        ...
        try
            ...
            conn = database(sap.databasename, '', '');
            setdbprefs('DataReturnFormat','numeric')
            conn_txt=sprintf('select * from %s',sap.SAPtablename_old);
            curs = exec(conn, conn_txt);
...
%                 fprintf('Stim bar plotting...\n');
                ...
                'ButtonDownFcn','ClassifySAP_sub_routines_04p8(''return_feature_2D_posi'')',...
...
%                         'ButtonDownFcn','ClassifySAP_sub_routines_04p8(''manual_change_cluster'')',...
...
%             num_teacher=length(find(sap.data(sap.pm.cluster_index,:)==ii));
    ...
    case 'show_trans_matrix'
        ...
        uicontrol('Style', 'pushbutton','String', 'show syllable','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'ClassifySAP_sub_routines_04p8(''choose_syllable_transition'');');
        sap.ui.decrement_transit_syllable=uicontrol('Style', 'pushbutton','String', '<','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'ClassifySAP_sub_routines_04p8(''move_syllable_transition'',-1);');
        sap.ui.edit_transit_syllable=uicontrol('Style', 'edit','String', '1','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'global sap; n=str2num(get(sap.ui.edit_transit_syllable,''String''));ClassifySAP_sub_routines_04p8(''move_syllable_transition'',n);');
    ...
    case 'manual_change_cluster'
        ...
        sap.gph.uieditnow=uicontrol('Style', 'edit','String', get(gcbo,'String'),...
            ...
            'UserData',tmp,...
            'Callback', 'ClassifySAP_sub_routines_04p8(''enter_cluster_number'');');
    ...
    case {'export_bout_durations'}
        ...
        text(.1*diff(xlim),.9*diff(ylim),sprintf('Median=%g(Mean=%g)',...
            median(sap.N_motif_counts),mean(sap.N_motif_counts)));
        subplot(2,1,2);
        
        bar(bout_dur_edges,N_bout_dur','histc');
        axis([min(bout_dur_edges) max(bout_dur_edges) ylim]);
        text(.1*diff(xlim),.9*diff(ylim),sprintf('Median=%g(Mean=%g)',...
            median(sap.bout_durations/1000),mean(sap.bout_durations/1000)));
    ...
    case 'kmeans_clustering'
        ClassifySAP_sub_routines_04p8('estimate_gaussian_mixture');
    ...
    case 'align_sonogram_plot'
        if nargin>=2
            ...
            fprintf('detect_pattern=%s\nalign_number=%d(%s),N=%d',...
                detect_pattern,align_number,align_pos,N);
...
%         post_start=5000;% index
        ...
        for val=1:length(str)
            ...
            str2=feval(mfilename,'return_song_txt',sap.pm.filename);
%             try 
%                 str2=sap.syllables(same_serial_index).note;
%             catch
%                 fprintf('Parsed syllable not found. Calculate.\n')
%                 feval(mfilename,'export_syllable_transitions');
%                 str2=sap.syllables(same_serial_index).note;
%             end
            
%             detect_pattern=strrep(detect_pattern,'.','+'); %I'm not sure why I needed. 
            ending_index=regexp(str2,detect_pattern);
            fprintf('look for %s in %s\n',detect_pattern,str2);
            Endline_ind=regexp(str2,'\n');
            ...
            if (is_exist_this_pattern)
                ...
                t_song=linspace(0,length(sap.pm.song)/sap.pm.Fsong,size(sap.pm.feature.m_spec_deriv,1));
                f=sap.pm.Fsong*(1:size(sap.pm.feature.m_spec_deriv,2))*1000/1024;
                
                
                for ll=1:length(ending_index)
                n_endline_before_this_syllable=sum(Endline_ind<ending_index(ll));
                correct_end_index=ending_index(ll)-n_endline_before_this_syllable;
                %                 sap.pm.show_sonogram_index=show_index_local(sap.pm.minind);
                sap.pm.show_sonogram_index=same_serial_index(correct_end_index+align_number-1);
                ...
                if isempty(onset_timing), continue;
                elseif length(onset_timing)>1 error;
                end
                
              
                h(jj)=mysubplot(max_N,1,jj,1);
                imagesc(t_song-onset_timing,f,sap.pm.feature.m_spec_deriv');
                ...
                switch data_type,
                    case 'cbr_mode',
                         try
                             load(fullfile(sap.pm.cbddata_dir,strrep(sap.pm.filename,'.wav','.mat')));
                         catch
                             sap.pm.cbddata_dir=uigetdir('Could not find cbd data directory. Where is is?')
                             load(fullfile(sap.pm.cbddata_dir,strrep(sap.pm.filename,'.wav','.mat')));
                        ...
                        medvtmp=my_medfilt1(vtmp,ceil(medfilt_t*sap.voldata(jj).Fs),10000);
                      
                        tind0=ceil((sap.voldata(jj).offset-0.2)*sap.voldata(jj).Fs);
                        tind0=max(1,tind0);
                        tind1=ceil(sap.voldata(jj).offset*sap.voldata(jj).Fs);
                        med_subtract=median(medvtmp(tind0:tind1));
                        
                        tind_s=floor((sap.voldata(jj).offset+xminplot)*sap.voldata(jj).Fs);
                        tind_s=max(1,tind_s);
                        tind_e=ceil((sap.voldata(jj).offset+xmaxplot)*sap.voldata(jj).Fs);
                        ...
                        sap.voldata(jj).med_subtract=med_subtract;
                        sap.voldata(jj).medv_plot=medvtmp(tind_s:tind_e);
                        
                        
                        
                        figure(sap.gph.aligned_vol_fig);
                        t_vol=linspace(xminplot,xmaxplot,length(sap.voldata(jj).medv_plot));
                        vol_legend_h(jj)=plot(t_vol,(sap.voldata(jj).medv_plot-med_subtract)*100,'Color',sap.pm.CS(jj,:)); hold on;
                        
                        same_serial_index = strmatch(sap.pm.filename,sap.data_filename);
                        stimind=find(sap.data(sap.pm.stimulated_index,same_serial_index)==-1);
                        stim_onsets= sap.data(sap.pm.start_on_index,same_serial_index(stimind))/1000-onset_timing
                        stim_offsets=sap.data(sap.pm.start_on_index,same_serial_index(stimind))/1000+...
                            sap.data(sap.pm.duration_index,same_serial_index(stimind))/1000-onset_timing
                        
                        line([stim_onsets(:),stim_offsets(:)],repmat(min(ylim)+diff(ylim)*0.01*jj,length(stim_onsets),2),'Color',sap.pm.CS(jj,:));
                        
                        legend_txt{jj}=sprintf('trial=%d, mean V=%1.3gmV',rand_index(val),median(sap.voldata(jj).medv_plot)*100);
                ...
                if jj<max_N
                    if (jj==1)
                        title(strrep(sprintf('Spectrum_%s, %d(%s)',...
        ...
        if isscalar(N)
         ...
         switch data_type,
                    case 'cbr_mode',
                        ...
                        savename=fullfile(sap.pm.analysis_dir,sprintf('Vol_%s_%d_%s_N=%s',...
                            strrep(detect_pattern,'\',''),align_number,align_pos,Ntxt));
         ...
         figure(sap.gph.amplitude_img_fig);
         savename=fullfile(sap.pm.analysis_dir,sprintf('Spectrum_%s_%d_%s_N=%s',...
             strrep(detect_pattern,'\',''),align_number,align_pos,Ntxt));         print(gcf,'-depsc2',[savename,'.eps']);
         ...
         switch answ
             case 'Yes'
                 figure(sap.gph.aligned_vol_fig);clf;
                 mvtmp=[sap.voldata(:).medv_plot]-...
                     repmat([sap.voldata(:).med_subtract],length(sap.voldata(1).medv_plot),1);
                 ...
                 axis(gca,[xminplot xmaxplot -15 30]);
                 savename=fullfile(sap.pm.analysis_dir,sprintf('MeanVol_%s_%d_%s_N=%s',...
                     strrep(detect_pattern,'\',''),align_number,align_pos,Ntxt));
                 fprintf('Saving voltage data in %s...\n',savename)
                 print(gcf,'-depsc2',[savename,'.eps']);
                 print(gcf,'-dpng',[savename,'.png']);
...
%         
    ...
    case 'export_features_of_a_syllable_type'   
        ...
        uicontrol('Style', 'pushbutton',...
            ...
            'Callback', 'ClassifySAP_sub_routines_04p8(''export_aligned_feature_within_xaxis'');');
