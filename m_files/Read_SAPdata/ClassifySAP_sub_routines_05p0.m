function varargout=ClassifySAP_sub_routines_05p0(opt,varargin)
...
%       features to be used in TemplateMaker    
% handles.template.teacher_feature_names={...
%     'duration',...
%     'entropy',...
%     'meanfreq',...
%     'FM',...
...
sap.pm.template_classify_dim_index=[...
    ...
    case 'init_figures'
        ...
        for ii=1:length(sap.pm.cluster_types)
            % evaltxt = sprintf('sap.gph.ui_cluster_type(%d) = uicontrol(''Style'',''Radio'',''Value'',0,''String'',sap.pm.cluster_types{%d},''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_cluster_type_select,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_05p0(''''%s'''')'');',...
        ...
        set(sap.gph.ui_cluster_type_select,'SelectionChangeFcn','ClassifySAP_sub_routines_05p0(''select_cluster_data_type'')');
        ...
        sap.gph.ui_teacher_cluster_ONOFF = uicontrol('Style','Radio',...
            ...
            'CallBack','ClassifySAP_sub_routines_05p0(''set_teacher_OnOff'');');
        sap.gph.ui_Stimlated_cluster_ONOFF = uicontrol('Style','Radio',...
            'Value',1,'String','stimulated','unit','normalized','pos',[.12 .90 .1 .03],...
            'CallBack','ClassifySAP_sub_routines_05p0(''set_Stimlated_cluster_ONOFF'');');
        ...
        sap.gph.ui_teacher_loadbutton = uicontrol('Style','pushbutton',...
            ...
            'CallBack','ClassifySAP_sub_routines_05p0(''load_teacher_database'');');
        ...
        dx = 1; dy=1/10;
        for ii=[0:8]
            evaltxt = sprintf('sap.gph.ui_cluster%d = uicontrol(''Style'',''Radio'',''Value'',1,''String'',[''cluster'' num2str(%d) '':(--)''],''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_clusterselect,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_05p0(''''%s'''')'');',...
                mod(ii,9),mod(ii,9),0,1-(ii+1)*dy,.6,'update_datatmp');
            eval(evaltxt);
        end
        ii=9; % for noise.
        evaltxt = sprintf('sap.gph.ui_cluster%d = uicontrol(''Style'',''Radio'',''Value'',1,''String'',[''noise'' num2str(%d) '':(--)''],''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_clusterselect,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_05p0(''''%s'''')'');',...
        ...
        sap.gph.ui_TgRS= uicontrol('Style','togglebutton',...
            ...
            'CallBack','ClassifySAP_sub_routines_05p0(''open_realsong_mode'');');
    
        
        yh=0.03;
        uicontrol('Style', 'pushbutton','String', 'show syllable',...
            'Unit','Normalized','Position', [.25 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''show_syllable'');');
        
        uicontrol('Style', 'pushbutton','String', 'redraw',...
            'Unit','Normalized','Position', [.35 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''redraw'');');
        
        uicontrol('Style', 'pushbutton','String', 'select&annotate',...
            'Unit','Normalized','Position', [.45 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''select_rect_annotate'');');
        
        
        
        uicontrol('Style', 'pushbutton','String', 'LoadDatabase',...
            'Unit','Normalized','Position', [.55 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''load_database'');');
        
        uicontrol('Style', 'pushbutton','String', 'LoadDB:DAK',...
            'Unit','Normalized','Position', [.55 .96 .09 yh],...
            'Tooltip','Load mysql database generated by .dak data','Callback', 'ClassifySAP_sub_routines_05p0(''load_database_dak'');');
        
        uicontrol('Style', 'pushbutton','String', {'LoadDB:RealSong'},...
            'Unit','Normalized','Position', [.55 .93 .09 yh],...
            'Tooltip','Load mysql database generated by RealSong data','Callback', 'ClassifySAP_sub_routines_05p0(''load_database_realsong'');');
        
        
        uicontrol('Style', 'pushbutton','String', 'UploadDatabase',...
            'Unit','Normalized','Position', [.65 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''upload_database'');');
        
        
        uicontrol('Style', 'pushbutton','String', 'EditAnalysisParam',...
            'Unit','Normalized','Position', [.75 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''open_analysis_parameters'');');
        
        uicontrol('Style', 'pushbutton','String', 'ShowPrincomp',...
            'Unit','Normalized','Position', [.85 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_05p0(''show_princomp_axis'');');
        ...
        uicontrol('Style', 'pushbutton','String', 'play song',...
            'Unit','Normalized','Position', pos0,'Callback', 'ClassifySAP_sub_routines_05p0(''play_wholesong'');');
        
        uicontrol('Style', 'pushbutton','String', 'print sonogram',...
            'Unit','Normalized','Position', pos1,'Callback', 'ClassifySAP_sub_routines_05p0(''print_sonogram'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ParseSyllable'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''parse_syllable_transitions'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'TrainSVM'},...
            ...
            'ToolTips','TrainSVM',...
            'Callback','ClassifySAP_sub_routines_05p0(''train_predict_svm'');');
        ...
        uicontrol('Style', 'pushbutton','String', 'ShowTransMat',...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''show_trans_matrix'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ShowSyllable','Transition'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''show_syllable_tree'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'AlignSongFeat'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''align_song'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'BoutMotifHist'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''export_bout_durations'');');
        pos1=pos1+[dx,0 0,0];
        uicontrol('Style', 'pushbutton','String', {'Syl&GapHist'},...
            'FontSize',8,...
            'Unit','Normalized','Position', pos1, ...
            'ToolTips','Export syllable gap histgram',...
            'Callback','ClassifySAP_sub_routines_05p0(''export_syllable_gap_hist'');');
...
%             'Callback','ClassifySAP_sub_routines_05p0(''train_predict_svm'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'AlignSonogram'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''align_sonogram_plot'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'DeleteSong'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''delete_song_from_database'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ExportFeatures'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''export_features_of_a_syllable_type'');');
         pos1=pos1+[0,yh 0,0];
        uicontrol('Style', 'pushbutton','String', {'ExportSyllableFile'},...
            'FontSize',8,...
            'Unit','Normalized','Position', pos1, ...
            'ToolTips','Export parsed syllable data into ASCII format.',...
            'Callback','ClassifySAP_sub_routines_05p0(''export_syllable_file'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ShowFeatures ToMakeTemplates'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''show_features_to_make_templates'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'ChangeSyllableThreshold'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''change_syllable_threshold'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'UpdateDetectedSyllables'},...
            ...
            'Callback','ClassifySAP_sub_routines_05p0(''update_detected_syllables'');');
        
        
        
        %         ClassifySAP_sub_routines_05p0('init_feature_vector');
        ...
        set(sap.gph.ui_xbuttonG,'SelectionChangeFcn','ClassifySAP_sub_routines_05p0(''chk_xaxis_button'')');
        ...
        % Initialize some button group properties.
        set(sap.gph.ui_ybuttonG,'SelectionChangeFcn','ClassifySAP_sub_routines_05p0(''chk_yaxis_button'')');
        ...
        sap.gph.ui_select_song_by_filename=uicontrol(...
            ...
            'Unit','Normalized',...
            'Position', [.01 .1 .24 .3],...
            'Callback', 'ClassifySAP_sub_routines_05p0(''select_song_by_filename'');');
        ...
        for ii=1:length(sap.pm.feature_names)
            ...
            evaltxt=sprintf('set(%s,''Callback'',''ClassifySAP_sub_routines_05p0(''''chk_feature_button'''')'')',button_uiname);
            eval(evaltxt);
        end
        ...
        sap.gph.ui_shown_cluster_as_noise=uicontrol('Style','pushbutton','String', 'Register as Noise',...
            'FontSize',8,...
            'Unit','Normalized','Position', [.87 .05 .1 .05],'Callback', 'ClassifySAP_sub_routines_05p0(''register_shown_cluster_as_noise'');');
        
        
        sap.gph.ui_register_shown_cluster_to_Manual_cluster=uicontrol('Style','pushbutton','String', 'Register',...
            'Unit','Normalized','Position', [.87 0 .1 .05],'Callback', 'ClassifySAP_sub_routines_05p0(''register_shown_cluster_to_Manual_cluster'');');
        
        sap.gph.ui_spectrum_contrast=uicontrol('Style','slider','Value', 0.1*(1-sap.pm.sonogram_caxis_cutooff),...
            'Unit','Normalized','Position', [.85 0.1 .01 .3],'Callback', 'ClassifySAP_sub_routines_05p0(''set_spectrum_contrast'');');
        ...
        sap.gph.ui_amplitude_thresh=uicontrol('Style','slider','Value', sap.gpm.amplitude_thresh,...
            ...
            'Visible', 'on',...
            'Callback', 'ClassifySAP_sub_routines_05p0(''set_amp_thresh'');');
    ...
    case 'readonly_database'
        ...
        rec_date=regexp([sap.distinct_data_filename{:}],'(\d{4})\w*(\d{6})','match');
...
%                 str2=filter_syllable_structure(str2,sap.pm.replace_chart,{});
                ...
                str2=feval(mfilename,'return_song_txt',sap.pm.filename);
        ...
        switch sap.pm.data_type
            ...
            case 'realsong'
                ...
                if FileExists(fullfile(sap.pm.sound_dir,sap.pm.filename))
                    load(fullfile(sap.pm.sound_dir,sap.pm.filename));
                    mic_index=[];
                    for kk=1:length(pm.rec_rawsignal_datanames)
                        if ~isempty(strfind(pm.rec_rawsignal_datanames{kk},'MIC'))
                            mic_index=kk+1;
                        end
                    end
                    if isempty(mic_index), error('NO MIC data in this file!');end
                    sap.pm.song=cbdata(:,mic_index);
                    sap.pm.Fsong= pm.SampRate/pm.decimation;
                else
                    error('%s does not exist!\n',fullfile(sap.pm.sound_dir,wavfile));
                end
            case 'dak'
        ...
        [sap.pm.feature.m_spec_deriv , ...
            ...
            sap.pm.feature2.f,...
            sap.pm.feature2.t,...
            sap.pm.feature2.param ]=sam_spectrum_deriv7(sap.pm.song,sap.pm.Fsong,'Parameters_high_resol_adaptive_steps',sap.pm.Fsong);
...
%                 fprintf('Stim bar plotting...\n');
                ...
                'ButtonDownFcn','ClassifySAP_sub_routines_05p0(''return_feature_2D_posi'')',...
...
%                         'ButtonDownFcn','ClassifySAP_sub_routines_05p0(''manual_change_cluster'')',...
...
%                 end
    ...
    case {'redraw_clusters','redraw_clusters_in_princomp'}
        ...
        for ii=0:9
            if (sap.pm.cluster_val(ii+1))
                ...
                h=plot(datatmp(sap.pm.xind,:),datatmp(sap.pm.yind,:),'k.','MarkerSize',6);hold on;
    ...
    case 'load_feature'
        ...
        is_dat_file=FileExists(fullfile(sap.pm.feature_dir,datname));
        matname= regexprep(sap.pm.feature_loadname,{'mat','wav'},'mat');
        is_mat_file=FileExists(fullfile(sap.pm.feature_dir,matname));
        
        dat_exist=FileExists(fullfile(sap.pm.feature_dir,datname));
        mat_exist=FileExists(fullfile(sap.pm.feature_dir,matname));
        
        if (dat_exist)&&(mat_exist)
            sap.pm.feature_data_is_mfile=1;
            feature_filename=fullfile(sap.pm.feature_dir,matname);
        elseif (dat_exist)
            sap.pm.feature_data_is_mfile=0;
            feature_filename=fullfile(sap.pm.feature_dir,datname);
        elseif (mat_exist)
            sap.pm.feature_data_is_mfile=1;
            feature_filename=fullfile(sap.pm.feature_dir,matname);
        else
...
%             num_teacher=length(find(sap.data(sap.pm.cluster_index,:)==ii));
    ...
    case 'show_trans_matrix'
        ...
        uicontrol('Style', 'pushbutton','String', 'show syllable','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'ClassifySAP_sub_routines_05p0(''choose_syllable_transition'');');
        sap.ui.decrement_transit_syllable=uicontrol('Style', 'pushbutton','String', '<','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'ClassifySAP_sub_routines_05p0(''move_syllable_transition'',-1);');
        sap.ui.edit_transit_syllable=uicontrol('Style', 'edit','String', '1','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'global sap; n=str2num(get(sap.ui.edit_transit_syllable,''String''));ClassifySAP_sub_routines_05p0(''move_syllable_transition'',n);');
    ...
    case 'manual_change_cluster'
        ...
        sap.gph.uieditnow=uicontrol('Style', 'edit','String', get(gcbo,'String'),...
            ...
            'UserData',tmp,...
            'Callback', 'ClassifySAP_sub_routines_05p0(''enter_cluster_number'');');
    ...
    case 'kmeans_clustering'
        ClassifySAP_sub_routines_05p0('estimate_gaussian_mixture');
    ...
    case 'align_sonogram_plot'
        ...
        if nargin>=2
            ...
            prompt={'Enter the detection pattern (ex: iiia+B+c+*, Captital means stimulated syllable.)',...
        ...
        if (IMGfig_open)&&(do_plot)
            sap.gph.spec_img_fig=findobj('Name','Aligned Sonogram');
            if isempty(sap.gph.spec_img_fig)
                sap.gph.spec_img_fig=...
                    figure('Name','Aligned Sonogram',...
                    'NumberTitle','off');clf;
            else
                figure(sap.gph.spec_img_fig);clf;
                delete(get(sap.gph.spec_img_fig,'Children'));
            end
        end
        
         if (subfig_open)&&(do_plot)
            sap.gph.aligned_sub_fig=findobj('Name',['Aligned',plot_sub_var]);
            if isempty(sap.gph.aligned_sub_fig)
                sap.gph.aligned_sub_fig=...
                    figure('Name',['Aligned',plot_sub_var],...
                    'NumberTitle','off');clf;
            else
                figure(sap.gph.aligned_sub_fig);clf;
                delete(get(sap.gph.aligned_sub_fig,'Children'))
            end
        end
        ...
        str=get(sap.gph.ui_select_song_by_filename,'String');
        str_ind=find(strncmp(filename_filter,str,length(filename_filter)));
        str=str(str_ind);
        ...
        for val=1:length(str)
            ...
            % determine which file to read
            sap.pm.filename=str{val};
            set(sap.gph.ui_select_song_by_filename,'Value',str_ind(rand_index(val)));
            drawnow;
            ...
            % now, find the notes that belongs to this file.
            same_serial_index = strmatch(sap.pm.filename,sap.data_filename);
            syl_index=same_serial_index(sap.data(sap.pm.stimulated_index,same_serial_index)>=0);
            stim_syl_index=same_serial_index(sap.data(sap.pm.stimulated_index,same_serial_index)>0);
            stim_index=same_serial_index(sap.data(sap.pm.stimulated_index,same_serial_index)<0);
            
                      
            songstr=feval(mfilename,'return_song_txt',sap.pm.filename);
            ...
            if (is_exist_this_pattern)
                ...
                if (do_plot)
                    ...
                    switch sap.pm.data_type
                        ...
                        case 'realsong'
                            ...
                            if FileExists(fullfile(sap.pm.sound_dir,sap.pm.filename))
                                ...
                                if isempty(rsd.amplitude)
                                    rsd.calc_spectrum_features;
                                end
                                
                                sap.pm.feature.m_spec_deriv=rsd.spect.m_spec_deriv;
                    ...
                    t_song=rsd.t; %linspace(0,length(sap.pm.song)/sap.pm.Fsong,size(sap.pm.feature.m_spec_deriv,1));
                    f=rsd.spect.f; %sap.pm.Fsong*(1:size(sap.pm.feature.m_spec_deriv,2))*1000/1024;
                end
...
%                                 + unique(sap.data(sap.pm.duration_index,sap.pm.show_sonogram_index)/1000);        
                    ...
                    if (do_plot),
                        ...
                        imagesc(t_song-t_offset,f,sap.pm.feature.m_spec_deriv');
                        ...
                        set(h(jj),'CLim',cutoff*[-1 1]*sap.gpm.max_spec,...
                            'YDir','Normal');
                    ...
                    switch data_type,
                        case 'cbr',
                            try
                                ...
                                sap.pm.Vdata_dir=uigetdir('Could not find cbd data directory. Where is is?')
                                load(fullfile(sap.pm.Vdata_dir,strrep(sap.pm.filename,'.wav','.mat')));
                            ...
                            vtmp=wavedata(1:3:end,2);
                            sap.aligndata(jj).offset=t_offset;
                            sap.aligndata(jj).Fs=sap.pm.Fsong/3;
                            medvtmp=my_medfilt1(vtmp,ceil(medfilt_t*sap.aligndata(jj).Fs),10000);
                            ...
                            if tind_e>length(medvtmp)
                                error('tind_e(%d) is larger than length(medvtmp)=%d\n',...
                                    tind_e,length(medvtmp));
                            end
                            ...
                            sap.aligndata(jj).medv_plot=medvtmp(tind_s:tind_e);
                            sap.aligndata(jj).v=vtmp(tind_s:tind_e);
                            sap.aligndata(jj).mic=sap.pm.song(3*tind_s:3*tind_e);
                            %                         sap.aligndata(jj).stim=vtmp(tind_s:tind_e);
                            
                            if (do_plot)
                            figure(sap.gph.aligned_sub_fig);
                            t_vol=linspace(xminplot,xmaxplot,length(sap.aligndata(jj).medv_plot));
                            vol_legend_h(jj)=plot(t_vol,(sap.aligndata(jj).medv_plot-med_subtract)*100,'Color',sap.pm.CS(jj,:)); hold on;
                            ...
                            line([stim_onsets(:),stim_offsets(:)],repmat(min(ylim)+diff(ylim)*0.01*jj,length(stim_onsets),2),'Color',sap.pm.CS(jj,:));
                        ...
                        case 'realsong'
                            ...
                            mic=rsd.mic;
                            playback=rsd.speaker;
                           
                     
                            
                            sap.aligndata(jj).offset=t_offset;
                            sap.aligndata(jj).Fs=rsd.Fs;
                            ...
                            if tind_e>length(medvtmp)
                                warning('tind_e(%d) is larger than length(medvtmp)=%d\nExtended data with NaN.',...
                                    tind_e,length(medvtmp));
                                medvtmp=[medvtmp;NaN(tind_e-length(medvtmp),1)];
                                vtmp=[vtmp;NaN(tind_e-length(vtmp),1)];
                                mic=[mic;NaN(tind_e-length(mic),1)];
                                stim=[stim;NaN(tind_e-length(stim),1)];
                            end
                            ...
                            sap.aligndata(jj).med_subtract=med_subtract;
                            sap.aligndata(jj).medv_plot=medvtmp(tind_s:tind_e);
%                             [size(vtmp),size(medvtmp)]
%                             [tind_s,tind_e]
                            sap.aligndata(jj).v   = 100*vtmp(tind_s:tind_e); % to make it mV.
                            
                            sap.aligndata(jj).mic = mic(tind_s:tind_e);
                            sap.aligndata(jj).playback = playback(tind_s:tind_e);
                            sap.aligndata(jj).recorded_stim=recorded_stim;
                            
                            sap.aligndata(jj).syl_onsets_all=syl_onsets_all(:)';
                            sap.aligndata(jj).syl_onsets=syl_onsets(:)';
                            sap.aligndata(jj).syl_offsets_all=syl_offsets_all(:)';
                            sap.aligndata(jj).syl_offsets=syl_offsets(:)';
                            ...
                            if ~isempty(regexp(detect_pattern,'[A-Z]'))
                            ...
                            sap.aligndata(jj).stim_onsets=stim_onsets;
                            sap.aligndata(jj).stim_offsets=stim_offsets;
                            
                            if (subfig_open)
                            figure(sap.gph.aligned_sub_fig);
                                     %                         vol_legend_h(jj)=plot(t_vol,(sap.aligndata(jj).medv_plot-med_subtract)*100,'Color',sap.pm.CS(jj,:)); hold on;
                            vol_legend_h(jj)=plot(t_vol,(sap.aligndata(jj).medv_plot)*100,'Color',sap.pm.CS(jj,:)); hold on;
        ...
        switch data_type,
            case {'cbr_mode','realsong'}
                if (do_plot)
                figure(sap.gph.aligned_sub_fig);
                legend(vol_legend_h,legend_txt,'Location','NorthEastOutside');
                h=[h,gca]; linkaxes(h,'x');
                axis(gca,[xminplot xmaxplot -100 30]);
                title(strrep(sprintf('Vol_%s, %d(%s)',...
                    strrep(detect_pattern,'\',''),align_number,align_pos),'_','\_'));
                
                end
                
                savename=fullfile(sap.pm.analysis_dir,...
                    sprintf('Vol_%s_%s_%d_%s_N=%d',...
                    save_ffr,strrep(detect_pattern,'\',''),align_number,...
                    align_pos,jj-1));
                fprintf('Saving voltage data in %s...\n',savename)
                aligndata=sap.aligndata;
                save([savename,'.mat'],'aligndata','t_vol');
        ...
        savename=fullfile(sap.pm.analysis_dir,...
            ...
            save_ffr,strrep(detect_pattern,'\',''),align_number,align_pos,jj-1));
            ...
            case {'cbr_mode','realsong'}
                ...
                switch answ
                    case 'Yes'
                        ...
                        mvtmp=mvtmp*100;  % make it mV.
                        mean_v=mean(mvtmp,2);
                        std_v = std(mvtmp,0,2);
                        plot_mean_conflimt(t_vol,mean_v,std_v,'c',1);hold on;
                        plot(t_vol,mean_v,'b');
...
%         
    ...
    case 'export_features_of_a_syllable_type'   
        ...
        uicontrol('Style', 'pushbutton',...
            ...
            'Callback', 'ClassifySAP_sub_routines_05p0(''export_aligned_feature_within_xaxis'');');
...
%         feval(song_analysis_mfile,'loadcbr',strrep(sap.pm.filename,'.wav','mat'),sap.pm.sound_dir);
    ...
    case 'return_song_txt'
        ...
        if nargin>=2
            ...
            error('it requires file name!');
        end
        
        [onset,durations,motif_counts,stimulated]=feval(mfilename,'return_bout_onset_duration_nmotif',filename,sap.pm.ISI_thresh);
%         for ii=1:length(onset)
%             fprintf('onsets=%6.5gms,\t durations=%6.4gms, \t (%2d motifs) (stimulated=%d)\n',onset(ii),durations(ii),motif_counts(ii),stimulated(ii));
%         end
%         sap.gph.bout_bar=[];
