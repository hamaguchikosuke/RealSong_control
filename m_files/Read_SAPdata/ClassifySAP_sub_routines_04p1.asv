function varargout=ClassifySAP_sub_routines_04p1(opt,varargin)
...
%                 size(tmpdata)
    ...
    case 'init_figures'
        ...
        for ii=1:length(sap.pm.cluster_types)
            % evaltxt = sprintf('sap.gph.ui_cluster_type(%d) = uicontrol(''Style'',''Radio'',''Value'',0,''String'',sap.pm.cluster_types{%d},''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_cluster_type_select,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_04p1(''''%s'''')'');',...
        ...
        set(sap.gph.ui_cluster_type_select,'SelectionChangeFcn','ClassifySAP_sub_routines_04p1(''select_cluster_data_type'')');
        ...
        sap.gph.ui_teacher_cluster_ONOFF = uicontrol('Style','Radio',...
            ...
            'CallBack','ClassifySAP_sub_routines_04p1(''set_teacher_OnOff'');');
         sap.gph.ui_Stimlated_cluster_ONOFF = uicontrol('Style','Radio',...
            'Value',1,'String','stimulated','unit','normalized','pos',[.12 .90 .1 .03],...
            'CallBack','ClassifySAP_sub_routines_04p1(''set_Stimlated_cluster_ONOFF'');');
        ...
        sap.gph.ui_teacher_loadbutton = uicontrol('Style','pushbutton',...
            ...
            'CallBack','ClassifySAP_sub_routines_04p1(''load_teacher_database'');');
        ...
        dx = 1; dy=1/10;
        for ii=[0:8]
            evaltxt = sprintf('sap.gph.ui_cluster%d = uicontrol(''Style'',''Radio'',''Value'',1,''String'',[''cluster'' num2str(%d) '':(--)''],''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_clusterselect,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_04p1(''''%s'''')'');',...
                mod(ii,9),mod(ii,9),0,1-(ii+1)*dy,.6,'update_datatmp');
            eval(evaltxt);
        end
        ii=9; % for noise.
        evaltxt = sprintf('sap.gph.ui_cluster%d = uicontrol(''Style'',''Radio'',''Value'',1,''String'',[''noise'' num2str(%d) '':(--)''],''unit'',''normalized'',''pos'',[%g,%g,%g,dy],''parent'',sap.gph.ui_clusterselect,''HandleVisibility'',''off'',''CallBack'',''ClassifySAP_sub_routines_04p1(''''%s'''')'');',...
        ...
        uicontrol('Style', 'pushbutton','String', 'show syllable',...
            'Unit','Normalized','Position', [.25 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''show_syllable'');');
        
        uicontrol('Style', 'pushbutton','String', 'redraw',...
            'Unit','Normalized','Position', [.35 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''redraw'');');
        
        uicontrol('Style', 'pushbutton','String', 'select&annotate',...
            'Unit','Normalized','Position', [.45 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''select_rect_annotate'');');
        
        
        
        uicontrol('Style', 'pushbutton','String', 'LoadDatabase',...
            'Unit','Normalized','Position', [.55 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''load_database'');');
       
         uicontrol('Style', 'pushbutton','String', 'LoadDatabase+DAK',...
            'Unit','Normalized','Position', [.55 .95 .09 yh],...
            'Tooltip','Load mysql database generated by .dak data','Callback', 'ClassifySAP_sub_routines_04p1(''load_database_dak'');');
       
        
        uicontrol('Style', 'pushbutton','String', 'UploadDatabase',...
            'Unit','Normalized','Position', [.65 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''upload_database'');');
       
           
        uicontrol('Style', 'pushbutton','String', 'EditAnalysisParam',...
            'Unit','Normalized','Position', [.75 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''open_analysis_parameters'');');
        
        uicontrol('Style', 'pushbutton','String', 'ShowPrincomp',...
            'Unit','Normalized','Position', [.85 .9 .09 yh],'Callback', 'ClassifySAP_sub_routines_04p1(''show_princomp_axis'');');
        ...
        uicontrol('Style', 'pushbutton','String', 'play song',...
            'Unit','Normalized','Position', pos0,'Callback', 'ClassifySAP_sub_routines_04p1(''play_wholesong'');');
        
         uicontrol('Style', 'pushbutton','String', 'print sonogram',...
            'Unit','Normalized','Position', pos1,'Callback', 'ClassifySAP_sub_routines_04p1(''print_sonogram'');');
        
        % uicontrol('Style', 'pushbutton','String', 'play syllable',...
        %     'Unit','Normalized','Position', [.2 .4 xw yh],'Callback', 'ClassifySAP_sub_routines_04p1(''play_syllable'');');
        
%         x=x+dx;
%         uicontrol('Style', 'pushbutton','String', 'show classification',...
%             'Unit','Normalized','Position', [x .4 xw yh],'Callback', 'ClassifySAP_sub_routines_04p1(''show_classification'');');
        %
        % uicontrol('Style', 'pushbutton','String', 'load feature',...
        %     'Unit','Normalized','Position', [.4 .4 xw yh],...
        %     'Callback', 'ClassifySAP_sub_routines_04p1(''load_feature'');');
...
%             'Callback','ClassifySAP_sub_routines_04p1(''auto_classify'');');
%         
%         
%         x=x+dx;
...
%             'Callback','ClassifySAP_sub_routines_04p1(''auto_classify_all'');');
...
%         x=x+dx;
        ...
        uicontrol('Style', 'pushbutton','String', {'ExportSyllable','Transitions'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p1(''export_syllable_transitions'');');
        ...
        uicontrol('Style', 'pushbutton','String', 'ShowTransMat',...
            ...
            'Callback','ClassifySAP_sub_routines_04p1(''show_trans_matrix'');');
       ...
       pos0=pos0+[dx,0 0,0];
        uicontrol('Style', 'pushbutton','String', {'ShowSyllable','Transition'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p1(''show_syllable_tree'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'AlignSong'},...
            ...
            'ToolTips','Show Syllable Tree',...
            'Callback','ClassifySAP_sub_routines_04p1(''align_song'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'BoutMotifHist'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p1(''export_bout_durations'');');
        pos1=pos1+[dx,0 0,0];
        uicontrol('Style', 'pushbutton','String', {'Syl&GapHist'},...
            'FontSize',8,...
            'Unit','Normalized','Position', pos1, ...
            'ToolTips','Export syllable gap histgram',...
            'Callback','ClassifySAP_sub_routines_04p1(''export_syllable_gap_hist'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'TrainSVM'},...
            ...
            'Unit','Normalized','Position', pos0, ...
            'ToolTips','TrainSVM',...
            'Callback','ClassifySAP_sub_routines_04p1(''train_predict_svm'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'AlignSonogram'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p1(''align_sonogram_plot'');');
        ...
        uicontrol('Style', 'pushbutton','String', {'DeleteSong'},...
            ...
            'Callback','ClassifySAP_sub_routines_04p1(''delete_song_from_database'');');
        
       
        
%         ClassifySAP_sub_routines_04p1('init_feature_vector');
        ...
        set(sap.gph.ui_xbuttonG,'SelectionChangeFcn','ClassifySAP_sub_routines_04p1(''chk_xaxis_button'')');
        ...
        % Initialize some button group properties.
        set(sap.gph.ui_ybuttonG,'SelectionChangeFcn','ClassifySAP_sub_routines_04p1(''chk_yaxis_button'')');
        ...
        sap.gph.ui_select_song_by_filename=uicontrol(...
            ...
            'Unit','Normalized',...
            'Position', [.01 .1 .24 .3],...
            'Callback', 'ClassifySAP_sub_routines_04p1(''select_song_by_filename'');');
        ...
        for ii=1:length(sap.pm.feature_names)
            ...
            evaltxt=sprintf('set(%s,''Callback'',''ClassifySAP_sub_routines_04p1(''''chk_feature_button'''')'')',button_uiname);
            eval(evaltxt);
        end
        ...
        sap.gph.ui_shown_cluster_as_noise=uicontrol('Style','pushbutton','String', 'Register as Noise',...
            'FontSize',8,...
            'Unit','Normalized','Position', [.87 .05 .1 .05],'Callback', 'ClassifySAP_sub_routines_04p1(''register_shown_cluster_as_noise'');');
        
        
        sap.gph.ui_register_shown_cluster_to_Manual_cluster=uicontrol('Style','pushbutton','String', 'Register',...
            'Unit','Normalized','Position', [.87 0 .1 .05],'Callback', 'ClassifySAP_sub_routines_04p1(''register_shown_cluster_to_Manual_cluster'');');
        
         sap.gph.ui_spectrum_contrast=uicontrol('Style','slider','Value', 0.1*(1-sap.pm.sonogram_caxis_cutooff),...
            'Unit','Normalized','Position', [.85 0.1 .01 .3],'Callback', 'ClassifySAP_sub_routines_04p1(''set_spectrum_contrast'');');
...
%         sap.pm.filename
        ...
        for ii=1:length(onset)
            fprintf('onsets=%6.4gms,\t durations=%6.4gms, \t (%2d motifs) (stimulated=%d)\n',onset(ii),durations(ii),motif_counts(ii),stimulated(ii));
        end
        sap.gph.bout_bar=[];
        for ii=1:length(onset)
...
%         cd(current_dir);
        ...
        for ii=1:length(sap.pm.same_serial_index)
            ...
            sap.gph.syllable_line(ii)=line(x-t_offset,[0 0],'Color','m','LineWidth',line_width,...
                'ButtonDownFcn','ClassifySAP_sub_routines_04p1(''return_feature_2D_posi'')',...
            ...
            if (show_label_num)
                ...
                set(sap.gph.syllable_label(ii),...
                    'ButtonDownFcn','ClassifySAP_sub_routines_04p1(''manual_change_cluster'')',...
    ...
    case 'chk_feature_button'
        ...
        for ii=1:lf
            if val(ii)
                ...
                tmp=tmp*ymax;
                lowamp_ind=find(sap.pm.feature.amplitude<-69.5);
                tmp(lowamp_ind)=NaN;
...
%             'XTick',[1:9],'XTickLabel',[1:9],'YTick',[1:9],'YTickLabel',[1:9]);
        ...
        uicontrol('Style', 'pushbutton','String', 'show syllable','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'ClassifySAP_sub_routines_04p1(''choose_syllable_transition'');');
        sap.ui.decrement_transit_syllable=uicontrol('Style', 'pushbutton','String', '<','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'ClassifySAP_sub_routines_04p1(''move_syllable_transition'',-1);');
        sap.ui.edit_transit_syllable=uicontrol('Style', 'edit','String', '1','Parent',sap.gph.ui_Transmat_panel,...
            ...
            'Callback', 'global sap; n=str2num(get(sap.ui.edit_transit_syllable,''String''));ClassifySAP_sub_routines_04p1(''move_syllable_transition'',n);');
...
%         fprintf('%d ',tmp(3:end));fprintf('\n');
        ...
        sap.gph.uieditnow=uicontrol('Style', 'edit','String', get(gcbo,'String'),...
            ...
            'UserData',tmp,...
            'Callback', 'ClassifySAP_sub_routines_04p1(''enter_cluster_number'');');
...
%                 sap.data(sap.pm.duration_index,same_serial_index(bout_ends(start_index_to_consider)));
    ...
    case 'kmeans_clustering'
        ClassifySAP_sub_routines_04p1('estimate_gaussian_mixture');
