 ...
 */
#ifndef RTW_HEADER_f14tmp1_h_
#define RTW_HEADER_f14tmp1_h_
#include "rtw_modelmap.h"
#ifndef f14tmp1_COMMON_INCLUDES_
# define f14tmp1_COMMON_INCLUDES_
...
#endif                                 /* f14tmp1_COMMON_INCLUDES_ */

#include "f14tmp1_types.h"
...
#define f14tmp1_rtModel                rtModel_f14tmp1
...
typedef struct {
  real_T TransferFcn2;                 /* '<S2>/Transfer Fcn.2' */
  real_T Gain5;                        /* '<S1>/Gain5' */
  real_T Derivative;                   /* '<S5>/Derivative' */
  real_T TransferFcn1;                 /* '<S2>/Transfer Fcn.1' */
  ...
  real_T Gain5_b;                      /* '<S2>/Gain5' */
  real_T Gain6;                        /* '<S2>/Gain6' */
  real_T Wgustmodel;                   /* '<S4>/W-gust model' */
  real_T Gain;                         /* '<S1>/Gain' */
  real_T Sum1_o;                       /* '<S2>/Sum1' */
  real_T Gain2_f;                      /* '<S1>/Gain2' */
  real_T Qgustmodel;                   /* '<S4>/Q-gust model' */
  real_T Gain1_h;                      /* '<S1>/Gain1' */
  real_T Sum;                          /* '<S1>/Sum' */
  real_T Sum2;                         /* '<S2>/Sum2' */
  real_T AlphasensorLowpassFilter;     /* '<S3>/Alpha-sensor Low-pass Filter' */
  real_T StickPrefilter;               /* '<S3>/Stick Prefilter' */
  real_T PitchRateLeadFilter;          /* '<S3>/Pitch Rate Lead Filter' */
  real_T Gain2_e;                      /* '<S3>/Gain2' */
  real_T Gain3_g;                      /* '<S3>/Gain3' */
  real_T Sum1_d;                       /* '<S3>/Sum1' */
  real_T Sum2_f;                       /* '<S3>/Sum2' */
  real_T Gain_d;                       /* '<S3>/Gain' */
  real_T Proportionalplusintegralcompens;/* '<S3>/Proportional plus integral compensator' */
  real_T Sum_n;                        /* '<S3>/Sum' */
  real_T WhiteNoise;                   /* '<S6>/White Noise' */
...
typedef struct {
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_RWORK;                  /* '<S5>/Derivative' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative1_RWORK;                 /* '<S5>/Derivative1' */
...
typedef struct {
  real_T TransferFcn2_CSTATE;          /* '<S2>/Transfer Fcn.2' */
  real_T TransferFcn1_CSTATE;          /* '<S2>/Transfer Fcn.1' */
  ...
  real_T AlphasensorLowpassFilter_CSTATE;/* '<S3>/Alpha-sensor Low-pass Filter' */
  real_T StickPrefilter_CSTATE;        /* '<S3>/Stick Prefilter' */
  real_T PitchRateLeadFilter_CSTATE;   /* '<S3>/Pitch Rate Lead Filter' */
  real_T Proportionalplusintegralcompens;/* '<S3>/Proportional plus integral compensator' */
} ContinuousStates_f14tmp1;
...
typedef struct {
  ...
  real_T PitchRateLeadFilter_CSTATE;   /* '<S3>/Pitch Rate Lead Filter' */
  real_T Proportionalplusintegralcompens;/* '<S3>/Proportional plus integral compensator' */
} StateDerivatives_f14tmp1;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn2_CSTATE;       /* '<S2>/Transfer Fcn.2' */
  boolean_T TransferFcn1_CSTATE;       /* '<S2>/Transfer Fcn.1' */
  ...
  boolean_T AlphasensorLowpassFilter_CSTATE;/* '<S3>/Alpha-sensor Low-pass Filter' */
  boolean_T StickPrefilter_CSTATE;     /* '<S3>/Stick Prefilter' */
  boolean_T PitchRateLeadFilter_CSTATE;/* '<S3>/Pitch Rate Lead Filter' */
  boolean_T Proportionalplusintegralcompens;/* '<S3>/Proportional plus integral compensator' */
} StateDisabled_f14tmp1;
...
#define rtB                            f14tmp1_B
#define BlockIO                        BlockIO_f14tmp1
#define rtX                            f14tmp1_X
#define ContinuousStates               ContinuousStates_f14tmp1
#define rtXdot                         f14tmp1_Xdot
#define StateDerivatives               StateDerivatives_f14tmp1
#define tXdis                          f14tmp1_Xdis
#define StateDisabled                  StateDisabled_f14tmp1
#define rtP                            f14tmp1_P
#define Parameters                     Parameters_f14tmp1
#define rtDWork                        f14tmp1_DWork
#define D_Work                         D_Work_f14tmp1

/* Parameters (auto storage) */
struct Parameters_f14tmp1_ {
...
extern Parameters_f14tmp1 f14tmp1_P;

/* Block signals (auto storage) */
extern BlockIO_f14tmp1 f14tmp1_B;

/* Continuous states (auto storage) */
extern ContinuousStates_f14tmp1 f14tmp1_X;

/* Block states (auto storage) */
extern D_Work_f14tmp1 f14tmp1_DWork;

/* Model entry point functions */
extern void f14tmp1_initialize(void);
extern void f14tmp1_output(void);
extern void f14tmp1_update(void);
extern void f14tmp1_terminate(void);

/* Real-time Model object */
extern rtModel_f14tmp1 *const f14tmp1_rtM;
 ...
 *
 * '<Root>' : 'f14tmp1'
 * '<S1>'   : 'f14tmp1/Subsystem'
 * '<S2>'   : 'f14tmp1/Subsystem/Aircraft Dynamics Model'
 * '<S3>'   : 'f14tmp1/Subsystem/Controller'
 * '<S4>'   : 'f14tmp1/Subsystem/Dryden Wind Gust Models'
 * '<S5>'   : 'f14tmp1/Subsystem/Nz pilot calculation'
 * '<S6>'   : 'f14tmp1/Subsystem/Dryden Wind Gust Models/Band-Limited White Noise'
 */
#endif                                 /* RTW_HEADER_f14tmp1_h_ */
