classdef KDA_Labview_dataclass < KinkaDataAnalysis_Default_dataclass
    ...
    methods
        function obj = KDA_Labview_dataclass(filename,file_format)
            
            obj=obj@KinkaDataAnalysis_Default_dataclass(filename);
