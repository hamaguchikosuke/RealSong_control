...
%   $Revision: 1.6.4.5 $  $Date: 2004/12/26 22:15:32 $

error(nargchk(2,7,nargin))
x = varargin{1};
y = varargin{2};
[msg,nfft,Fs,window,noverlap,p,dflag]=psdchk(varargin(3:end),x,y); %#ok
error(msg)
...
Coh = Pxy./sqrt(abs(Pxx.*Pyy));             % coherence function estimate 
